                        ...
                        <div className={"mt-5 "+responsive.m25l_on_sm}>
                            <div className={"row"}>
                                <div className={`col mb-2 ${styles.about_container}`}>
                                    <img alt="" className={styles.about_avatar + ' ' + responsive.w170f_on_sm} src="/about/raqsanta.png" />
                                    <div className={`${styles.about_overlay}`}>
                                        <div className={`${styles.about_text_overlay} container`}>
                                            ...
                                            <a href="https://github.com/raqsanta" target="_blank" rel="noreferrer" className={"btn btn-dark rounded-pill " + responsive.hide_on_ssm}>Conhecer</a>
                                        </div>
                                    </div>
                                </div>
                                <div className={`col mb-2 ${styles.about_container}`}>
                                    <img alt="" className={styles.about_avatar + ' ' + responsive.w170f_on_sm} width="256" height="256" src="/about/thayanne.png" />
                                    <div className={`${styles.about_overlay}`}>
                                        <div className={`${styles.about_text_overlay} container`}>
                                            ...
                                            <a href="https://github.com/thayannestella" target="_blank" rel="noreferrer" className={"btn btn-dark rounded-pill " + responsive.hide_on_ssm}>Conhecer</a>
                                        </div>
                                    </div>
                                </div>
                                <div className={`col ${styles.about_container}`}>
                                    <img alt="" className={styles.about_avatar + ' ' + responsive.w170f_on_sm} width="256" height="256" src="/about/laryssa.png" />
                                    <div className={`${styles.about_overlay}`}>
                                        <div className={`${styles.about_text_overlay} container`}>
                                            ...
                                            <a href="https://github.com/larysilvaak" target="_blank" rel="noreferrer" className={"btn btn-dark rounded-pill " + responsive.hide_on_ssm}>Conhecer</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="row mt-3">
                                <div className={`col mb-2 ${styles.about_container}`}>
                                    <img alt="" className={styles.about_avatar + ' ' + responsive.w170f_on_sm} width="256" height="256" src="/about/antony.png" />
                                    <div className={`${styles.about_overlay}`}>
                                        <div className={`${styles.about_text_overlay} container`}>
                                            ...
                                            <a href="https://github.com/AntonyMatheus" target="_blank" rel="noreferrer" className={"btn btn-dark rounded-pill " + responsive.hide_on_ssm}>Conhecer</a>
                                        </div>
                                    </div>
                                </div>
                                <div className={`col mb-2 ${styles.about_container}`}>
                                    <img alt="" className={styles.about_avatar + ' ' + responsive.w170f_on_sm} width="256" height="256" src="/about/mariana.png" />
                                    <div className={`${styles.about_overlay}`}>
                                        <div className={`${styles.about_text_overlay} container`}>
                                            ...
                                            <a href="https://github.com/zeelds" target="_blank" rel="noreferrer" className={"btn btn-dark rounded-pill " + responsive.hide_on_ssm}>Conhecer</a>
                                        </div>
                                    </div>
                                </div>
                                <div className={`col mb-2 ${styles.about_container}`}>
                                    <img alt="" className={styles.about_avatar + ' ' + responsive.w170f_on_sm} width="256" height="256" src="/about/gr.png" />
                                    <div className={`${styles.about_overlay}`}>
                                        <div className={`${styles.about_text_overlay} container`}>
                                            <h5>Girl React</h5>
                                            ...
                                            <a href="https://github.com/girl-react" target="_blank" rel="noreferrer" className={"btn btn-dark rounded-pill " + responsive.hide_on_ssm}>Conhecer</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
